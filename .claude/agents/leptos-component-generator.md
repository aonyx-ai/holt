...
6. **Visual Iteration and Refinement**: Use the render-variant command to
   ...
   - After creating stories, use
     `just kit-docs render-variant <story_id> <variant> <output_path>` to render
     specific variants
   ...
   - Examples:
     - `just kit-docs render-variant button 0 ./button-default.png`
     - `just kit-docs render-variant button destructive ./button-destructive.png`
     - `just kit-docs render-variant select 2 ./select-variant.png`
